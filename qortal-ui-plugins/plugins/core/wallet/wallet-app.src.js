...
const coinsNames = ['qort', 'btc', 'ltc', 'doge', 'dgb', 'rvn', 'qrl']
...
class MultiWallet extends LitElement {
    ...
    constructor() {
	  ...
	  this.balance = 0
        ...
        this.qrlFeePerByte = 20 //unknown
        this.qrlSatMinFee = 1000 //unknown
        this.qrlSatMaxFee = 100000 //unhknown
                ...
                <div class="wallet">
                    ...
                    <div class="cards">
                        ...
                        <div coin="qrl" class="currency-box qrl">
                            <div class="currency-image"></div>
                            <div class="currency-text">QRL</div>
                        </div>
                    </div>
                </div>
    ...
    closeQrlDialog() {
        this.shadowRoot.querySelector('#sendQrlDialog').close()
        this.successMessage = ''
        this.errorMessage = ''
    }
