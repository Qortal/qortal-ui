...
import { userInfoViewStyles } from '../../styles/core-css'
							...
							<vaadin-grid theme="compact" id="lastQortPaymentsGrid" ?hidden="${this.isEmptyArray(this.slicedArray)}" .items="${this.slicedArray}">
								<vaadin-grid-column
									...
									.renderer=${(root, column, data) => {
										render(html`${translate("walletpage.wchange40")} ${data.item.creatorAddress === this.displayAddress ? html`
				...
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							...
							id="explorerBTCTradesGrid"
							aria-label="Explorer Bought With BTC"
			...
			<div class="explorer-trades">
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							theme="compact column-borders row-stripes wrap-cell-content"
							id="explorerLTCTradesGrid"
							aria-label="Explorer Bought With LTC"
			...
			<div class="explorer-trades">
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							theme="compact column-borders row-stripes wrap-cell-content"
							id="explorerDOGETradesGrid"
							aria-label="Explorer Bought With DOGE"
			...
			<div class="explorer-trades">
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							theme="compact column-borders row-stripes wrap-cell-content"
							id="explorerDGBTradesGrid"
							aria-label="Explorer Bought With DGB"
			...
			<div class="explorer-trades">
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							theme="compact column-borders row-stripes wrap-cell-content"
							id="explorerRVNTradesGrid"
							aria-label="Explorer Bought With RVN"
				...
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							...
							aria-label="Explorer Bought With ARRR"
				...
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							theme="compact column-borders row-stripes wrap-cell-content"
							id="explorerBTCTradesGrid"
							aria-label="Explorer Sold With BTC"
				...
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							theme="compact column-borders row-stripes wrap-cell-content"
							id="explorerLTCTradesGrid"
							aria-label="Explorer Sold With LTC"
				...
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							theme="compact column-borders row-stripes wrap-cell-content"
							id="explorerDOGETradesGrid"
							aria-label="Explorer Sold With DOGE"
				...
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							theme="compact column-borders row-stripes wrap-cell-content"
							id="explorerDGBTradesGrid"
							aria-label="Explorer Sold With DGB"
				...
				<div class="box">
					...
					<div class="border-wrapper">
						...
						<vaadin-grid
							theme="compact column-borders row-stripes wrap-cell-content"
							id="explorerRVNTradesGrid"
							aria-label="Explorer Sold With RVN"
